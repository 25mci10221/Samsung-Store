...
def place_order_action():
    ...
    try:
        # Insert into ORDERS table (Starts implicit transaction)
        order_query = "INSERT INTO ORDERS (order_id, total_amount, order_date) VALUES (%s, %s, NOW())"
        cursor.execute(order_query, (order_id, total_price)) 
